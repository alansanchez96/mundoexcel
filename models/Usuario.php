...
class Usuario extends ActiveRecord {
    ...
    protected static $columnasDB = ['id','nombre','apellido','email','telefono','dni','password','password1','admin','confirmado','token','picture','biografia','website','facebook','twitter','linkedin'];
